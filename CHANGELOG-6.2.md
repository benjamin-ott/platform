...
* Storefront
    ...
    * Fix setting slider initialized class in `BaseSliderPlugin` and `GallerySliderPlugin` to prevent slider items from popping up underneath each other before the slider is fully initialized.
